...
namespace ReCapProject.Business.Concrete.Managers
{
    public class AuthManager : IAuthService
    {
        ...
        private ITokenHelper _tokenHelper; // kullanıcı login olduğunda token verdik bizimkisi JwtHelper dı
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password) // kayıt olma aşamaları
        {
